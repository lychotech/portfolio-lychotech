...
function contact() {
  window.location.href = "https://wa.me/6374790349/";
};
...
function sendEmail() {
  ...
  <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f9f9f9;">
    <div style="background-color: #ffffff; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
      ...
      <span style="margin: 0;">&copy;Babu Selvan</span>
    </div>
    </div>
  </div>
`;
  ...
  Email.send({
    ...
    Username: "tbabuselvan432@gmail.com",
    Password: "A102F29237740404C78B465046CC02EE6C18",
    To: 'tbabuselvan432@gmail.com',
    From: "tbabuselvan432@gmail.com",
...
document.addEventListener("visibilitychange", function () {
  if (document.visibilityState === "visible") {
    document.title = "Portfolio | Babu Selvan";
  } else {
